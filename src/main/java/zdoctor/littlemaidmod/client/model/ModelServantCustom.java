...
public class ModelServantCustom extends CustomModelBase {
	...
	public ModelServantCustom() {
		this(0.0F);
	}

	public ModelServantCustom(float modelSize) {
		this(modelSize, 64, 32);
	}

	public ModelServantCustom(float modelSize, int textureWidthIn, int textureHeightIn) {
